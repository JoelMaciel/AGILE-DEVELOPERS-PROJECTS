...
import com.joelmaciel.agiledevprojects.domain.exception.BusinessException;
import com.joelmaciel.agiledevprojects.domain.exception.EntityNotExistException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
        ...
        if (ex instanceof MethodArgumentTypeMismatchException mismatchException) {
            return handleMethodArgumentTypeMismatch(
                    mismatchException, headers, (HttpStatus) status, request);
        }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        if (rootCause instanceof InvalidFormatException invalidFormatException) {
            return handleInvalidFormat(invalidFormatException, headers, (HttpStatus) status, request);
        } else if (rootCause instanceof PropertyBindingException propertyBindingException) {
            return handlePropertyBinding(propertyBindingException, headers, (HttpStatus) status, request);
        }
